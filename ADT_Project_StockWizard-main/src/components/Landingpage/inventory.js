    ...
    inventoryRef.orderByChild("inventoryId")
      ...
      .once("value", snapshot => {
        if (snapshot.exists()) {
          ...
          // Check if another item with the same Product name already exists
          inventoryRef.orderByChild("productName")
            .equalTo(inventoryData.productName)
            .once("value", snapshot => {
              if (snapshot.exists()) {
                alert("An item with the same Product name already exists.");
              } else {
